...
/*!*************************************!*\
  !*** ./frontend/actions/actions.js ***!
  \*************************************/
/*! exports provided: RECEIVE_INITIAL_DATA, TOGGLE_PANELS, receiveInitialData, togglePanels, requestInitialData */
...
const mapDispatchToProps = dispatch => ({
    togglePanels: () => dispatch(Object(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["togglePanels"])())
});
...
const contentReducer = (state = _defaultState, action) => {
    ...
    switch (action.type) {
        ...
        case _actions_actions__WEBPACK_IMPORTED_MODULE_0__["TOGGLE_PANELS"]:
            {
                const newState = Object.assign({}, state);
